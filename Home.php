...
<?php include 'assets/header.php'; ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<div class="banner-txt-home">
						<h5>CANANDA'S #1</h5>
						<h1>PREMIUM QUALITY<br>CBD OIL.</h1>
						<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias, eos quasi eligendi consequuntur id nam itaque incidunt repudiandae eius exercitationem saepe autem blanditiis.</p>	
						<button>Shop Now
	...
	<section class="Help-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 help-row">
					<h1>WHAT CAN WE HELP YOU WITH?</h1>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim <br> veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. </p>
				</div>
			</div>
	...
	<section class="multi-parts">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 r1c">
...
<section class="products">
	...
	<div class="row productrow">
		...
		<div class="col-lg-3 topseller-txt">
			<h3>TOP SELLER</h3>
		</div>
		<div class="col-lg-4">
			<hr>
...
<section>
	<div class="container">
		<div class="row pr">
			<div class="col-3 sec">
                <a href="productdetail.html"><img src="images/seller1.png"></a>
                <p class="description">Lorem ipsum dolor sit 
                            amet, consecteturelit, sed  
                            do eiusmod tempor</p>
...
<section class="products">
	...
	<div class="row productrow">
		...
		<div class="col-lg-3 newproduct-txt">
			<h3>NEW PRODUCT</h3>
		</div>
		<div class="col-lg-4">
			<hr>
